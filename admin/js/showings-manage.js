...
async function saveShowing(e) {
    ...
    const showingData = {
        ...
        total_seats: parseInt(document.getElementById('showing-seats').value) || 48,
        price: parseFloat(document.getElementById('showing-price').value) || 0
    };
    ...
    try {
        ...
        if (response.success) {
            document.getElementById('showing-modal').style.display = 'none';
            loadShowings();
            loadDashboard();
        } else {
